...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="navbar-collapse collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ml-auto">
        ...
        <a class="nav-item nav-link" href="viewuser.php">View</a>
...
if(isset($_POST['issue'])){
    ...
    $issueQry = "INSERT into issuerequest VALUES('','$timingIssue','$descriptionIssue','$category','$name','$uname','$issued','$unit','$dept','$scheme','$inventory')";
    ...
    <div class="entmainndi">
      ...
      <div id="entformarea">
        <div class="form-group entform-group">
          ...
          <input class="form-control" id="timingIssue" value="<?php echo date('Y-m-d'); ?>" name="timingIssue">
        </div>
       <div class="form-group entform-group">
        ...
        <div class="form-group entform-group">
          ...
          <input type="text" class="form-control" id="issued" placeholder="Enter Quantity" name="issued" onkeyup="compare(this)" required>
        </div>
        ...
        <div class="form-group entform-group">
          ...
          <input type="text" class="form-control" id="name" placeholder="Enter Name" name="remark">
                ...
                <div class="form-group entform-group">
          <label for="idNo">Username</label>
          <input type="text" class="form-control" id="uname" value="<?php echo $_SESSION['name']; ?>" name="uname" disabled>
        </div>
